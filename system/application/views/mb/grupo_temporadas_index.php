    ...
    <div id="zonaContenido">
        <div align="center">
            ...
            <div id="botonBusqueda">
                <ul id="nuevoGrupo" class="lista_botones"><li id="nuevo"> Nuevo Grupo </li></ul> 
                <ul id="limpiarGrupo" class="lista_botones"><li id="limpiar"> Limpiar </li></ul>
                <ul id="buscarGrupo" class="lista_botones"><li id="buscar"> Buscar Grupos </li></ul> 
            </div>
            <div id="lineaResultado">
                <table class="fuente8" width="100%" cellspacing=0 cellpadding=3 border=0>
                    <tr>
                        <td width="50%" align="left">
                            Número de grupos encontrados: <strong><?php echo $registros ?></strong>
                        </td>
            ...
            <div id="frmResultado">
                <table class="fuente8" width="100%" cellspacing="0" cellpadding="3" border="0" ID="Table1">
                    <tr class="cabeceraTabla">
                        <td width="20"> ITEM</td>
                        <td width="120"> GRUPO DE TEMPORADAS </td>
                    ...
                    ?>
                                <tr class="<?php echo $class ?>">
                                    ...
                                    <td>
                                        <div align="center">
                                            <a href="#" onclick="ver(<?php echo $valor[1] ?>)">
                                    ...
                                    <td>
                                        <div align="center">
                                            <a href="#" onclick="editar(<?php echo $valor[1] ?>)">
                                                <img src="<?php echo base_url()?>images/modificar.png" width="16" 
                                    ...
                                    <td>
                                        <div align="center">
                                            <a href="#" onclick="eliminar(<?php echo $valor[1] ?>)">
                                                <img src="<?php echo base_url()?>images/eliminar.png" width="16" 
                                                     height="16" border="0" title="Eliminar" />
                                            </a>
                                        </div>
                                    </td>
                                </tr>
