...
<div id="zonaContenido">
    ...
    <div id="frmBusqueda" >
        <form id="form_busquedaRol" name="form_busquedaRol" method="post" action="">
            <table class="fuente8" width="98%" cellspacing=0 cellpadding="5" border=0>
                <tr>
                    <td align='left' width="13%">Nombre Plan</td>
    ...
    <div id="botonBusqueda">
        <ul id="nuevoPlan" class="lista_botones"><li id="nuevo">Nuevo Plan</li></ul>
        <ul id="limpiar" class="lista_botones"><li id="limpiar">Limpiar</li></ul>
        <ul id="buscarPlan" class="lista_botones"><li id="buscar">Buscar</li></ul>
    </div>
    <div id="lineaResultado">
      <table class="fuente8" width="100%" cellspacing=0 cellpadding=3 border=0>
            <tr>
                <td width="50%" align="left">N de planes encontrados:&nbsp;<?php echo $registros;?> </td>
        ...
        <table class="fuente8" width="100%" cellspacing="0" cellpadding="3" border="0" ID="Table1">
            ...
            if(count($lista)>0){
                foreach($lista as $key=>$value){
					...
					$principal = ($value[4] == '1')?'<img src="'.base_url().'images/icono_aprobar.png" width="18" height="15" border="0" title="ES PRINCIPAL" />':'';
                    ?>
                    <tr class="<?php echo $class;?>">
                        ...
                        <td><div align="center"><a href="javascript:;" onclick="editar_plan(<?= $value[1] ?>)"><img src="<?=base_url()?>images/modificar.png" width='16' height='16' border='0' title='Modificar'></a></div></td>
                        <td><div align="center"><a href="javascript:;" onclick="eliminar_plan(<?= $value[1] ?>)"><img src="<?=base_url()?>images/eliminar.png" width='16' height='16' border='0' title='Modificar'></a></div></td>
                    </tr>
                    <?php
                }
            }else{
