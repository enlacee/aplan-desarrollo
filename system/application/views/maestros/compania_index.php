...
<div id="zonaContenido">
    ...
    <div id="frmBusqueda" >
        <form id="form_busquedaRol" name="form_busquedaRol" method="post" action="">
            <table class="fuente8" width="98%" cellspacing=0 cellpadding="5" border=0>
                <tr>
                    <td align='left' width="13%">Nombre Compa&ntilde;ia</td>
    ...
    <div id="botonBusqueda">
        <ul id="nuevoCompania" class="lista_botones"><li id="nuevo">Nueva Compa&ntilde;a</li></ul>
        <ul id="limpiar" class="lista_botones"><li id="limpiar">Limpiar</li></ul>
        <ul id="buscarCompania" class="lista_botones"><li id="buscar">Buscar</li></ul>
    </div>
    <div id="lineaResultado">
      <table class="fuente8" width="100%" cellspacing=0 cellpadding=3 border=0>
            <tr>
                <td width="50%" align="left">N de compa&ntilde;as encontrados:&nbsp;<?php echo $registros;?> </td>
