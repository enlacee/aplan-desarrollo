...
class Persona_model extends Model
{
    ...
    public function listar_personas(){
        ...
        $query = $this->db->order_by('PERSC_ApellidoPaterno')->where('PERSC_FlagEstado','1')->get('cji_persona');
        if($query->num_rows>0){
    ...
    /*public function insertar_datosPersona($ubigeo_nacimiento,$ubigeo_domicilio,$estado_civil,$nacionalidad,$nombres,$paterno,$materno,$ruc,$tipo_documento,$numero_documento='',$direccion='',$telefono='',$movil='',$email='',$domicilio='',$sexo='',$fax='',$web='',$ctactesoles='',$ctactedolares=''){
        $data = array(
	...
	public function insertar_datosPersona($nombres,$paterno,$materno){
        $data = array(
                    "PERSC_Nombre"             => strtoupper($nombres),
                    "PERSC_ApellidoPaterno"    => strtoupper($paterno),
                    "PERSC_ApellidoMaterno"    => strtoupper($materno)
    ...
    public function modificar_datosPersona($persona,$ubigeo_nacimiento,$ubigeo_domicilio,$estado_civil,$nacionalidad,$nombres,$paterno,$materno,$ruc,$tipo_documento,$numero_documento,$direccion,$telefono,$movil,$email,$domicilio,$sexo,$fax,$web,$ctactesoles,$ctactedolares)
    {
       $data = array(
                    "UBIGP_LugarNacimiento"    =>$ubigeo_nacimiento,
                    "UBIGP_Domicilio"          =>$ubigeo_domicilio,
