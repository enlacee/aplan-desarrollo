...
jQuery(document).ready(function(){
	...
	$("#nuevoRol").click(function(){
		url = base_url+"seguridad/rol/nuevo";
		location.href = url;
	});
	...
	$("#limpiarRol").click(function(){
            url = base_url+"seguridad/rol/listar";
            $("#txtNombre").val('');
            $("#txtRol").val('');
...
function editar_rol(rol){
	location.href = base_url+"seguridad/rol/editar/"+rol;
}
function eliminar_rol(rol){
	if(confirm('¿Está seguro que desea eliminar este rol?')){
        dataString        = "rol="+rol;
        $.post("eliminar",dataString,function(data){
                location.href = base_url+"seguridad/rol/listar";
        });
	}
}
function ver_rol(rol){
	location.href = base_url+"seguridad/rol/ver/"+rol;
}
function atras_rol(){
	location.href = base_url+"seguridad/rol/listar";
}
